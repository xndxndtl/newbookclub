...
const debugRouteLinkMap = {
  '/auth2Create':
      'https://app.flutterflow.io/project/bookclub-75k2jc?tab=uiBuilder&page=auth_2_Create',
  '/auth2Login':
  ...
  '/auth2Profile':
      'https://app.flutterflow.io/project/bookclub-75k2jc?tab=uiBuilder&page=auth_2_Profile',
  '/auth2EditProfile':
      'https://app.flutterflow.io/project/bookclub-75k2jc?tab=uiBuilder&page=auth_2_EditProfile',
  '/welcomePage':
      'https://app.flutterflow.io/project/bookclub-75k2jc?tab=uiBuilder&page=WelcomePage',
  '/home':
      'https://app.flutterflow.io/project/bookclub-75k2jc?tab=uiBuilder&page=Home'
};
